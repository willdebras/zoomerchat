...
library(shinythemes)
library(auth0)
#shinysense needs to be downloaded from forked version:
#remotes::install_github("willdebras/shinysense")   
library(shinysense)
...
ui <- fluidPage(
    ...
    navbarPage("",
               tabPanel("Shiny Chat",
                        ...
                        mainPanel(actionButton("toggleSidebar", "Toggle chat")#,
...
server <-function(input, output, session) {
    ...
    #here we will want a renderUI() to render video feeds as people join
